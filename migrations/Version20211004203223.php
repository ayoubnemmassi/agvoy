 ...
 */
final class Version20211004203223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fisrtname VARCHAR(255) DEFAULT NULL, familyname VARCHAR(255) NOT NULL, mail CLOB NOT NULL, password CLOB NOT NULL, phonenumber VARCHAR(255) DEFAULT NULL, address CLOB NOT NULL, type VARCHAR(255) NOT NULL)');
