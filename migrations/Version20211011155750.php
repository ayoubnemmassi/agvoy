 ...
 */
final class Version20211011155750 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, isVerified BOOLEAN DEFAULT \'0\')');
