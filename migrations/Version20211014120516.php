 ...
 */
final class Version20211014120516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, room_id INTEGER DEFAULT NULL, comment CLOB DEFAULT NULL)');
        ...
        $this->addSql('INSERT INTO reservation (id, room_id, user_id, date, periode, price, status) SELECT id, room_id, user_id, date, periode, price, status FROM __temp__reservation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__reservation AS SELECT id, room_id, user_id, date, periode, price, status FROM reservation');
        $this->addSql('DROP TABLE reservation');
        $this->addSql('CREATE TABLE reservation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room_id INTEGER NOT NULL, user_id INTEGER NOT NULL, date DATETIME NOT NULL, periode DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, status BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO reservation (id, room_id, user_id, date, periode, price, status) SELECT id, room_id, user_id, date, periode, price, status FROM __temp__reservation');
        $this->addSql('DROP TABLE __temp__reservation');
        $this->addSql('CREATE INDEX IDX_42C8495554177093 ON reservation (room_id)');
        $this->addSql('CREATE INDEX IDX_42C84955A76ED395 ON reservation (user_id)');
